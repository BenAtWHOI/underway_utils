...
function remove_openrvdas {
    yes_no "Remove install root? " false
...
function remove_user {
    yes_no "Remove OpenRVDAS user? " false
...
function remove_firewall {
    yes_no "Remove firewall configuration? " false
...
function remove_supervisor {
    yes_no "Remove supervisor? " false
...
function remove_ssl_certificate {
    yes_no "Remove ssl certificate? " false
...
function remove_python_packages {
    yes_no "Remove python packages? " false
...
function remove_logs_and_tmp {
    yes_no "Remove log and temporary directories? " false
